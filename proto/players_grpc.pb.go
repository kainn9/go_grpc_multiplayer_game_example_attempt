...
const (
	PlayersService_PlayerLocation_FullMethodName = "/players.PlayersService/PlayerLocation"
)
...
func (c *playersServiceClient) PlayerLocation(ctx context.Context, opts ...grpc.CallOption) (PlayersService_PlayerLocationClient, error) {
	stream, err := c.cc.NewStream(ctx, &PlayersService_ServiceDesc.Streams[0], PlayersService_PlayerLocation_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
