...
func HeavyKnightAttacks() map[AtKey]*AttackData {
...
func heavyKnightPrimaryAtk(atks map[AtKey]*AttackData) map[AtKey]*AttackData {
...
func heavyKnightSecondaryAtk(atks map[AtKey]*AttackData) map[AtKey]*AttackData {
